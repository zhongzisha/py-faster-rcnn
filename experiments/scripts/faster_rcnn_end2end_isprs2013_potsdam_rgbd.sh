...
time ./tools/train_net.py --gpu ${GPU_ID} \
  --solver models/pascal_voc/${NET}/faster_rcnn_end2end_isprs2013_potsdam_rgbd/solver.prototxt \
  --weights ${NET_INIT} \
  --imdb ${DATASET_TRAIN} \
  --iters ${ITERS} \
  --cfg experiments/cfgs/faster_rcnn_end2end_isprs2013_potsdam_rgbd.yml \
  ${EXTRA_ARGS}
...
time ./tools/test_net.py --gpu ${GPU_ID} \
  --def models/pascal_voc/${NET}/faster_rcnn_end2end_isprs2013_potsdam_rgbd/test.prototxt \
  --net ${NET_FINAL} \
  --imdb ${DATASET_TEST} \
  --cfg experiments/cfgs/faster_rcnn_end2end_isprs2013_potsdam_rgbd.yml \
  ${EXTRA_ARGS}
